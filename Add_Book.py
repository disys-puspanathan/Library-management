...
print("Enter a no_of_currentcopies")    
no_of_currentcopies=int(input())
...
SQLCommand = ("INSERT INTO gp_book_details(book_id, book_name, author, binding_id, no_of_actualcopies, no_of_currentcopies, category, publication_year, reviews) VALUES (?,?,?,?,?,?,?,?,?)")    
Values = [book_id, book_name, author, binding_id, no_of_actualcopies, no_of_currentcopies, category, publication_year, reviews]  
